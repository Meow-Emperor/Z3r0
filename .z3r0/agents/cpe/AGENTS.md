...
Provide coverage, validated findings, suspected leads, useful negatives, blockers, cleanup state, retest triggers, evidence references, and next action. In a work project, submit the bound work item only after its targets are concluded and its material claims have active evidence.
