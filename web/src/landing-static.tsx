...
function LandingStaticRoot() {
  useAutoHideScrollbars();
  return <LandingContent logoSrc={z3r0Logo} primaryAction={landingPrimaryAction} />;
}

const landing = <React.StrictMode><LandingStaticRoot /></React.StrictMode>;
